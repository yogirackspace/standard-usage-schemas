...
class ValidateWithRoles extends BaseUsageSuite {
  ...
  test("should pass when getting bigdata/events/12345 feed JSON Content with Accept: application/xml and X-ROLES:cloudfeeds:observer ") {
  ...
  test("should pass when GET with /bigdata entry JSON Content as observer with Accept application/xml") {
